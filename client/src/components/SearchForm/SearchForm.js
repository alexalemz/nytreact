      ...
      <div className="card">
        ...
        <div className="card-body">
          <form onChange={this.props.handleInputChange} onSubmit={this.props.handleFormSubmit}>
            ...
            <Input name="startYear" id="startYear" label="Start Year" value={this.props.state.startYear} />
            <Input name="endYear" id="endYear" label="End Year" value={this.props.state.endYear} />
